              ...
              <>
                <div>
                    ...
                    <div className="textIcon relative mb-6">
                     <div id="icon" className="absolute top-3 left-0 translate-y-1/2 flex items-center text-lg pl-3 pointer-events-none">
                        <BsChatTextFill />
                     </div>
                      <Textarea
                        placeholder='Message'
                    ...
                    <div className='my-4'>
                        <Button className='bg-green hover:bg-green/60 uppercase transition rounded-xl text-midnight-black text-base font-medium px-8 py-2'>Send Message</Button>
                    </div>
                </div>
              </>
            );
