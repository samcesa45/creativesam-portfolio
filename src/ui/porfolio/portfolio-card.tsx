...
export default function PortfolioCard({ data }: { data: Portfolio }) {
  return (
    <div className="card_stylings overflow-hidden h-full">
      <Image
        src={data?.image}
        className="w-full object-cover opacity-60  h-32 sm:h-48 md:h-64"
      ...
      >
        <div className="flex justify-between p-0 m-0">
          ...
          <div className="text-snow transition duration-500 hover:text-yellow-500 transform hover:-translate-y-1 hover:scale-110 pt-4 text-base">
            <Link href={data?.url} target="_blank">
              <svg
                aria-hidden="true"
                focusable="false"
